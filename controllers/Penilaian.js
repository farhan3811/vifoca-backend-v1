...
export const getPenilaian = async (req, res) => {
    ...
    const order = [['updatedAt', sortOrder]]; // `updatedAt` is the correct field name in Sequelize
    ...
    try {
        ...
        // If user is admin, show all results; otherwise, only show their own records
